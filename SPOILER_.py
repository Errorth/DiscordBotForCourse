'''
    YY    YY
     YY  YY        ZZZZZZZZ        NNN    NN         ii        KK  KK
      YYYY               ZZ        NN N   NN                   KK K
       YY              ZZ          NN  N  NN         II        KKK
       YY            ZZ            NN   N NN         II        KKK
       YY          ZZ              NN    NNN         II        KK K
       YY          ZZZZZZZZ        NN     NN         II        KK  KK
...
class slash_commands:
    ...
    async def ban(
        ...
        await member.send('`Если вы считаете что вас наказали не честно. Можете обратиться к следящей за Модераторами адмнистрацией: Mayki#5252, I\'m Jester#4949`')
